...
def generate_launch_description():
    ...
    gazebo_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            'gz_args': f'-v 4 {os.path.join(get_package_share_directory(package_name), 'worlds', 'empty_plane.world')}'  # Launch empty world (-r for headless if you want no GUI; remove -r for GUI)
        }.items()
    )
